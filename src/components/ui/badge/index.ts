  ...
  "inline-flex items-center justify-center rounded-full border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-emerald-600 text-white [a&]:hover:bg-emerald-600/90 focus-visible:ring-emerald-500/20 dark:bg-emerald-500 dark:text-slate-950 dark:[a&]:hover:bg-emerald-500/90",
        "success-light":
          "border-transparent bg-emerald-100 text-emerald-800 [a&]:hover:bg-emerald-200/80 dark:bg-emerald-950/40 dark:text-emerald-400 dark:[a&]:hover:bg-emerald-950/60",
      },
    },
    defaultVariants: {
      variant: "default",
